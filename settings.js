...
//—————「 Setting Owner 」—————//
global.owner = ['6281334170366'] //ubah jadi nomor kamu
global.premium = ['6281334170366'] //ubah jadi nomor kamu
global.ownernomer = '6281334170366' //ubah jadi nomor kamu

//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'Bot Bonanza︎' //ubah jadi nama kamu
global.botname = 'Bot Bonanza︎' //ubah jadi nama bot kamu
global.footer = 'Bot Bonanza︎' //ubah jadi nama kamu

//—————「 Set Kebutuhan Button & Kontak 」—————//
global.youtube = 'https://youtu.be/N-Z9ugGpeYk' //ubah jadi link yt kmu, kalau gk pnya gsh di gnti anggap aja credits :)
global.ig = 'https://chat.whatsapp.com/CAPptYDgkOI3V4vAOcC3tW' //ubah jadi link ig kamu
global.mygc = 'https://chat.whatsapp.com/CAPptYDgkOI3V4vAOcC3tW' //ubah jadi link group kamu
...
//—————「 Set Wm 」—————//
global.packname = '© Bot Bonanza' //ubah jadi nama bot kamu
global.author = 'Bot Bonanza' //ubah jadi nama kamu
